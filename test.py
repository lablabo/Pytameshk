...
async def demo():
    ...
    issuer = {
        ...
        'wallet_config': json.dumps({'id': 'issuer_wadllet'}),
        'wallet_credentials': json.dumps({'key': 'issuer_wallet_key'})
    }
    prover = {
        'did': 'VsKV7grR1BUE29mG2Fm2kX',
        'wallet_config': json.dumps({"id": "prover_walldet"}),
        'wallet_credentials': json.dumps({"key": "issuer_wallet_key"})
    }
    verifier = {}
    store = {}
    ...
    print(prover['cred_req'])
    print(prover['cred_req_metadata'])
