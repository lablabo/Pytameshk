    ...
    async  def get_token(self):
        try:
            ...
            if response_one.status_code == 200:
                ...
                did_verkey_json = await crypto.unpack_message(self.wallet_handle, response_one.content)
                did_verkey_json = did_verkey_json.decode('utf-8')
                did_verkey_json = json.loads(did_verkey_json)['message']
                did_verkey_json = json.loads(did_verkey_json)
                ...
                proof = await anoncreds.prover_create_proof(
                    self.wallet_handle,
                    json.dumps(did_verkey_json['proof_request']),
                ...
                if response_one.status_code == 200:
                    ...
                    did_verkey_json_two = await crypto.unpack_message(self.wallet_handle, response_two.content)
                    did_verkey_json_two = did_verkey_json_two.decode('utf-8')
                    did_verkey_json_two = json.loads(did_verkey_json_two)['message']
                    did_verkey_json_two = json.loads(did_verkey_json_two)
                    exit(did_verkey_json_two)
                    ...
                    did_verkey_json_three = await crypto.unpack_message(self.wallet_handle, response_three.content)
                    did_verkey_json_three = did_verkey_json_three.decode('utf-8')
                    did_verkey_json_three = json.loads(did_verkey_json_three)['message']
                    did_verkey_json_three = json.loads(did_verkey_json_three)
                    exit(did_verkey_json_three)
